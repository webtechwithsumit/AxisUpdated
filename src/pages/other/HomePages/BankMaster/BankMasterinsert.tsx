...
const BankMasterinsert = () => {
    ...
    const fetchStaffRequirementsId = async (id: string) => {
        try {
            const response = await axios.get(`${config.API_URL}/BankMaster/GetBankList`, {
                params: { id: id }
            });
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            if (editMode) {
                await axios.post(`${config.API_URL}/BankMaster/UpdateBank`, payload);
                ...
                await axios.post(`${config.API_URL}/BankMaster/InsertBank`, payload);
                navigate('/pages/BankMaster', {
                    state: {
