...
const SignOffProduct = () => {
    ...
    const storedEmpName = localStorage.getItem('EmpId');
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'createdDate', label: 'End Date', visible: true },
        { id: 'dayLaps', label: 'Days Lapsed', visible: true },
        { id: 'dayLaps', label: 'Sign off by Department', visible: true },
        { id: 'dayLaps', label: 'Refrence Number', visible: true },
    ...
    const fetchDetailsMain = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL}/Product/GetProductDetails?Flag=4`, {
                params: { PageIndex: currentPage, UserName: storedEmpName }
            });
                            ...
                            <div className='bg-white p-2 pb-2'>
                                <Row >
                                    <div className="d-flex justify-content-between profilebar p-1">
                                        <h4 className='text-primary d-flex align-items-center m-0'><i className="ri-file-list-line me-2 text-primary "></i> Sign-Off Product </h4>
