...
const ProductMasterInsert = () => {
    ...
    const handleCheckbox = (id: number, status: number) => {
        ...
        if (input.files) {
            ...
            files.forEach((file) => {
                if (file.type.startsWith('image/')) {
                    ...
                    // For non-image files, just add an empty preview (no image preview)
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const payload = {
                ...
                DefaultAssignee: product.assignee,
                DefaultAssigneeID: product.assigneeID,
                                        ...
                                        <Row>
                                            ...
                                            <Col lg={6}>
                                                <Form.Group controlId="assignee" className="mb-3">
                                                    ...
                                                    <Select
                                                        name="productType"
                                                        value={employeeList.find((emp) => emp.userName === product.assignee)}
                                                        onChange={(selectedOption) => {
                                                            setProduct({
                                                                ...product, assignee: selectedOption?.userName || '',
                                                                assigneeID: selectedOption?.userName || '',
                                                            });
                                                        }}
                                                                                ...
                                                                                <li key={index} className="position-relative mb-1">
                                                                                    {file.type.startsWith('image/') ? (
                                                                                        ...
                                                                                        <div className='d-flex align-items-center justify-content-between cursor-pointer'
                                                                                            ...
                                                                                            <span>
                                                                                                <i
                                                                                                    className='ri-eye-line text-dark bg-light rounded-circle p-1'
                                                                    ...
                                                                    <tr key={`${checkList.id}-${checkList.name}`}>
                                                                        ...
                                                                        <td>
                                                                            <Form.Check
                                                                                ...
                                                                                onChange={() => handleCheckbox(checkList.id, 1)}
                                                                            />
                                                                        </td>
                                                                        <td>
                                                                            <Form.Check
                                                                                ...
                                                                                onChange={() => handleCheckbox(checkList.id, 0)}
                                                                            />
                                                                        </td>
                                                                    </tr>
                                                                ))}
