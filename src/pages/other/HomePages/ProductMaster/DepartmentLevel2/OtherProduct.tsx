        ...
        const popover = (
            <Popover id={`popover-action-${item.id}`} className="shadow">
                <Popover.Body className="p-2">
                    ...
                    <Button variant="link" as={Link as any} to={`/pages/discussionForum/${item.id}`} className="d-block text-start text-danger">
                        <i className="ri-close-line me-2"></i> Reject
                    </Button>
                    <Button variant="link" as={Link as any} to={`/pages/discussionForum/${item.id}`} className="d-block text-start text-success">
                        <i className="ri-checkbox-circle-line me-2"></i> Approve
                    </Button>
                            ...
                            <div className='bg-white p-2 pb-2'>
                                <Row className=''>
                                    <div className="d-flex justify-content-between bg-light p-1 profilebar">
                                        <h4 className='text-primary d-flex align-items-center m-0'><i className="ri-file-list-line me-2 text-primary "></i> Other Department Product </h4>
