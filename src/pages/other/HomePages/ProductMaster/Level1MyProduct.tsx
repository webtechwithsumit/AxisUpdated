            ...
            <div className='bg-white p-2 pb-2'>
                <Row className='mt-3'>
                    <div className="d-flex justify-content-between profilebar p-1">
                        <h4 className='text-primary d-flex align-items-center m-0'><i className="ri-file-list-line me-2 text-primary "></i>   Product Organised by My  Department </h4>
...
export default Level1MyProduct;