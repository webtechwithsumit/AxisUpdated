...
const DiscussionForum = () => {
    ...
    const storeduserName = localStorage.getItem('EmpName');
                                    ...
                                    <div className='my-2'>
                                        <Row>
                                            ...
                                            <Col lg={4}>
                                                ...
                                                <span className="text-dark"> {discussion.createdDate}</span>
                                            </Col>
                                            <Col lg={4}>
                                            ...
                                            <tr>
                                                ...
                                                <td className=''>
                                                    <div className="text-center">
                                                        ...
                                                        {storeduserName === discussion.asigneeName ? (
                                                            <Button
                                                                variant="info"
