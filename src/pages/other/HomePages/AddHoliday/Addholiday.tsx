...
const dummyHolidays: Holiday[] = [
    { id: 1, name: 'New Year', date: '2024-01-01', description: 'New Year Celebration' },
    { id: 2, name: 'Republic Day', date: '2024-01-26', description: 'National Holiday' },
    { id: 3, name: 'Good Friday', date: '2024-04-07', description: 'Christian Holiday' },
    { id: 4, name: 'Independence Day', date: '2024-08-15', description: 'National Holiday' },
    { id: 5, name: 'Christmas', date: '2024-12-25', description: 'Christmas Celebration' }
];


const DesignationMaster = () => {
    const [mails, setMails] = useState<Holiday[]>(dummyHolidays);
        ...
        <div className='p-3 mt-3 bg-white'>
            <Row className=' mb-2 px-2'>
                <div className="d-flex justify-content-between profilebar p-1">
                    <h4 className='text-primary d-flex align-items-center m-0'><i className="ri-file-list-line me-2 text-primary "></i>Manage Holiday</h4>
                    <div className="d-flex justify-content-end bg-light w-50 profilebar">

                        <Link to='/pages/Addholidayinsert'>
                                                ...
                                                mails.slice(0, 10).map((item, index) => (
                                                    <tr key={item.id}>
                                                        ...
                                                        {columns.filter((col) => col.visible).map((col) => (
                                                            ...
                                                            >
                                                                <div>{item[col.id as keyof Holiday]}</div>
                                                            </td>
                                                        ))}
