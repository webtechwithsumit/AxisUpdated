...
const EmployeeMaster = () => {
    ...
    const convertToCSV = (data: Manager[]) => {
        const csvRows = [
            [
                'ID',
                'Manager Name',
        ...
        <div className='p-3 mt-3 bg-white'>
            <Row className=' mb-2 px-2'>
                <div className="d-flex justify-content-between profilebar p-1">
                    <h4 className='text-primary d-flex align-items-center m-0'><i className="ri-file-list-line me-2 text-primary "></i>  Manager List </h4>
                    <div className="d-flex justify-content-end bg-light w-50 profilebar">
                        ...
                        <Link to='/pages/ManagerMasterinsert'>
                                            ...
                                            employee.slice(0, 10).map((item, index) => (
                                                <tr key={item.id}>
                                                    ...
                                                    <td className='text-center'>
                                                        <Link to={`/pages/ManagerMasterinsert/${item.id}`}>
